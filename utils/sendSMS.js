...
export const sendSmsRegReminder = async (
  ...
  const params = {
    authkey: process.env.SMS_API_AUTHKEY,
    mobiles: `91${mobile}`,
    message: `Dear ${studentName}, registration is complete and seat is reserved. To confirm your seat at DigiCoders, please pay the ₹${amount} registration fee now: ${paymentLink}`,
    sender: process.env.SENDER_ID,
    route: 4,
    country: 91,
...
export const sendSmsInstallmentReceived = async (
  ...
  const params = {
    ...
    mobiles: `91${mobile}`,
    message: `Dear ${studentName}, ₹${amount} installment received. Thank you for the payment. - DigiCoders Technologies Pvt. Ltd.`,
    sender: "DIGICO",
    route: 4,
    country: 91,
